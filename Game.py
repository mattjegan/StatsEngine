...
class Game:
    def __init__(self, team1, team1players, team2, team2players, date):
        ...
        def getTeam1Players(self): return self.team1players
        def getTeam2Players(self): return self.team2players
        def getTeam1(self): return self.team1
        def getTeam2(self): return self.team2
        def getScore(self):
